                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        <Link href={'/'} className="flex items-center gap-2 text-xl font-bold tracking-tight text-[#082a5e]">
                            ...
                            <span className="bg-linear-to-r from-[#082a5e] to-[#1e4ebd] bg-clip-text text-transparent dark:text-white">IdeaVault</span>
                        </Link>
                        ...
                        <div className="flex items-center gap-4 pt-2">
                            <a href="#" className="btn btn-ghost btn-circle btn-sm hover:bg-base-200 dark:hover:bg-transparent text-[#082a5e] dark:text-white dark:border-0 hover:text-[#1e4ebd]" aria-label="Facebook">
                            ...
                            <a href="#" className="btn btn-ghost btn-circle btn-sm hover:bg-base-200 dark:hover:bg-transparent text-[#082a5e] dark:text-white dark:border-0 hover:text-[#1e4ebd]" aria-label="Twitter/X">
                            ...
                            <a href="#" className="btn btn-ghost btn-circle btn-sm hover:bg-base-200 dark:hover:bg-transparent text-[#082a5e] dark:text-white dark:border-0 hover:text-[#1e4ebd]" aria-label="LinkedIn">
            ...
            <div className="border-t border-base-200 bg-base-200/30">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-base-content/60">
                    ...
                    <div className="flex items-center gap-6">
                        <Link href="/privacy" className="hover:text-white dark:hover:text-white transition-colors">Privacy Policy</Link>
                        <Link href="/terms" className="hover:text-white dark:hoover:text-white transition-colors">Terms of Service</Link>
                    </div>
                </div>
            </div>
        </footer>
