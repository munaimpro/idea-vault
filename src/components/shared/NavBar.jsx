            ...
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href={'/'} className="flex items-center gap-2 text-xl font-bold tracking-tight text-[#082a5e] hover:opacity-90 transition-opacity">
                        <span className="p-2 bg-[#082a5e] text-white rounded-xl shadow-sm text-sm font-black">MV</span>
                        <span className="hidden sm:inline bg-gradient-to-r select-none from-[#082a5e] to-[#1e4ebd] bg-clip-text text-transparent">MediaVault</span>
                    </Link>
                </div>
