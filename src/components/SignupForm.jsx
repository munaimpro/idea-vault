        ...
        <div>
            <Form onSubmit={onSubmit} className="flex flex-col gap-4.5">
                ...
                <TextField isRequired name="name" type="name" className="w-full">
                    <Label className="text-xs font-bold uppercase tracking-wide text-[#082a5e]/80 dark:text-white mb-1.5 block">Name</Label>
                ...
                <TextField name="image" type="url" className="w-full">
                    <Label className="text-xs font-bold uppercase tracking-wide text-[#082a5e]/80 dark:text-white mb-1.5 block">Image URL</Label>
