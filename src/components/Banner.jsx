                        ...
                        >
                            ...
                            <div className="hero-content justify-start text-left text-white w-full px-6 sm:px-12 lg:px-20 z-10 py-20">
                                <div className="max-w-2xl space-y-6">
                                    ...
                                    <div className="pt-2">
                                        <Link  href={'/ideas'} className="btn bg-white hover:bg-base-200 text-[#082a5e] dark:hover:bg-white border-none font-bold rounded-xl px-8 shadow-lg shadow-[#082a5e]/20 transition-all duration-300 hover:scale-[1.02] btn-sm sm:btn-md">
                                            Explore Ideas
                                        </Link>
                                    </div>
                                </div>
